...
<form action="<?=base_url('index.php/ArticulosC/insertArticulo') ?>" method="POST">
  <div class="col">
    <label for="Juego_Sala" class="fs-5 text-center text-uppercase">Juego de Sala</label>
  ...
  <div class="col">
    <label for="Juego_Comedor" class="fs-5 text-center text-uppercase">Juego de Comedor</label>
  ...
  <div class="col">
    <label for="Television" class="fs-5 text-center text-uppercase">Television</label>
