...
<form action="<?=base_url('index.php/ServiciosC/insertServicio') ?>" method="POST">
  <div class="col">
  ...
  <div class="col">
    <label for="Television_Abierta" class="fs-5 text-center text-uppercase">Televisión Abierta</label>
  ...
  <div class="col">
    <label for="Television_Paga" class="fs-5 text-center text-uppercase">Televisión de Paga</label>
